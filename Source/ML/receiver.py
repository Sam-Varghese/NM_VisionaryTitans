...
class Frontend:
    def __init__(self, databaseConnector: DatabaseConnector, frame_queue):
        self.css = '''
            <style>
                body {
            ...
            '''
        self.logo_img = Image.open(r"D:\VS Code Workspace\Fair Space\GitHub\NM_VisionaryTitans\Source\Frontend\logo_title.jpg")
